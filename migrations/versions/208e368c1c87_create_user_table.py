...
Revision ID: 208e368c1c87
Revises: bdd2c89cf021
Create Date: 2024-11-22 20:22:27.455637
...
revision = "208e368c1c87"
down_revision = "bdd2c89cf021"
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "role", sa.Enum("ADMIN", "USER", name="user_auth_role_enum"), nullable=False
        ),
        sa.Column("created_at", sa.TIMESTAMP(), nullable=True),
        sa.Column("updated_at", sa.TIMESTAMP(), nullable=True),
        ...
        sa.Column(
            "status",
            sa.Enum("ACTIVE", "INACTIVE", "BANNED", name="user_auth_status_enum"),
            nullable=False,
        ),
